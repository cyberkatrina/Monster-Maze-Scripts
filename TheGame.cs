...
namespace IndieMarc.TopDown
{
    public class TheGame : MonoBehaviour
    {
        ...
        [SerializeField] GameObject _torchParent;
        ...
        void Awake()
        {
            _instance = this;
            PlayerData.Load();
            torchController = torch.GetComponent<TorchController>();
        }
        ...
        void Update()
        {
            //Turns on light if torch picked up (destroyed game object)
            if (torchController.torchCollected == true)
            {
